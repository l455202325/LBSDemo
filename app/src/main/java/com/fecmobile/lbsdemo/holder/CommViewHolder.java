package com.fecmobile.lbsdemo.holder;
...
import com.fecmobile.lbsdemo.BaseApplication;
import com.nostra13.universalimageloader.core.listener.SimpleImageLoadingListener;

/** 通用的ViewHolder写法 */
public class CommViewHolder {

	private final SparseArray<View> mViews;//hanson:android系统建议我们用SparseArray<E>来代替HashMap<Integer, E>
	...
	public CommViewHolder setImageByUrl(final int viewId, String url) {
		BaseApplication.imageLoader.displayImage(url,
				(ImageView) getView(viewId), BaseApplication.options);
		return this;
	}
	...
	public CommViewHolder setImageByUrlLoadImage(int viewId, String url) {
		...
		BaseApplication.imageLoader.loadImage(url,
